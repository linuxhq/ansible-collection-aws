...
Check these `module_utils` helpers before writing equivalent local logic.
...
| `.common.dict_transformations` | `camel_dict_to_snake_dict` | CamelCase → snake_case.       |
| `.common.dict_transformations` | `dict_merge`               | Deep-merge dicts.             |
| `.common.dict_transformations` | `recursive_diff`           | Structural diff.              |
| `.common.dict_transformations` | `snake_dict_to_camel_dict` | snake_case → CamelCase.       |
