  ...
  tunnel_options:
    ...
    suboptions:
        ...
        Phase1EncryptionAlgorithms:
            ...
            elements: dict
            description:
              - The permitted encryption algorithms for IKE phase 1.
            suboptions:
              Value:
                type: str
                description:
        ...
        Phase1IntegrityAlgorithms:
            ...
            elements: dict
            description:
              - The permitted integrity algorithms for IKE phase 1.
            suboptions:
              Value:
                type: str
                description:
        ...
        Phase1DHGroupNumbers:
            ...
            elements: dict
            description:
              - The permitted Diffie-Hellman group numbers for IKE phase 1.
            suboptions:
              Value:
                type: int
                description:
        ...
        Phase2EncryptionAlgorithms:
            ...
            elements: dict
            description:
              - The permitted encryption algorithms for IKE phase 2.
            suboptions:
              Value:
                type: str
                description:
        ...
        Phase2IntegrityAlgorithms:
            ...
            elements: dict
            description:
              - The permitted integrity algorithms for IKE phase 2.
            suboptions:
              Value:
                type: str
                description:
        ...
        Phase2DHGroupNumbers:
            ...
            elements: dict
            description:
              - The permitted Diffie-Hellman group numbers for IKE phase 2.
            suboptions:
              Value:
                type: int
                description:
...
def add_routes(
    ...
    routes_to_add: List[Dict[str, Any]],
) -> bool:
    changed: bool = False
...
def remove_routes(
    ...
    module: AnsibleAWSModule,
    vpn_connection_id: str,
    routes_to_remove: List[Dict[str, Any]],
) -> bool:
    changed: bool = False
...
def create_connection(
    ...
    if tunnel_options and len(tunnel_options) <= 2:
        ...
        for m in tunnel_options:
            ...
            t_opt.append(scrub_none_parameters(m))
        if t_opt:
    ...
    try:
        ...
        module.fail_json_aws(
            e,
            msg=f"Failed to wait for VPN connection {vpn['VpnConnectionId']} to be available",
        )
    except AnsibleEC2Error as e:
    ...
    argument_spec = dict(
        ...
        tunnel_options=dict(
            ...
            options=dict(
                ...
                Phase1EncryptionAlgorithms=dict(
                    type="list",
                    elements="dict",
                    options=dict(Value=dict(type="str")),
                ),
                Phase1IntegrityAlgorithms=dict(
                    type="list",
                    elements="dict",
                    options=dict(Value=dict(type="str")),
                ),
                Phase1DHGroupNumbers=dict(
                    type="list",
                    elements="dict",
                    options=dict(Value=dict(type="int")),
                ),
                Phase2EncryptionAlgorithms=dict(
                    type="list",
                    elements="dict",
                    options=dict(Value=dict(type="str")),
                ),
                Phase2IntegrityAlgorithms=dict(
                    type="list",
                    elements="dict",
                    options=dict(Value=dict(type="str")),
                ),
                Phase2DHGroupNumbers=dict(
                    type="list",
                    elements="dict",
                    options=dict(Value=dict(type="int")),
                ),
